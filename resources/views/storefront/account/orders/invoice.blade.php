...
<head>
    ...
    @vite(['resources/css/storefront.scss'])
    <style>
        @media print {
...
<body>
    <div class="container py-4" style="max-width: 800px;">
        <div class="d-flex justify-content-end gap-2 mb-3 no-print">
            ...
            <a href="{{ route('storefront.account.orders.show', $order) }}" class="btn btn-outline-secondary">Back to Order</a>
        </div>

        <div class="bg-white rounded p-4 p-md-5">
            <div class="d-flex justify-content-between align-items-start mb-4">
                <div>
                    {{-- <h1 class="h4 mb-0">{{ \App\Models\WebsiteSetting::get('site_name', config('app.name', 'Jewellery Store')) }}</h1> --}}
                    <h1 class="h4 mb-0">RELYDRIP</h1>
